...
<div class="row" style="padding: 10px">
    <a type="button" data-bs-toggle="modal" data-bs-target="#createRecordModal" class="btn btn-dark btn-icon-split" style="width: 12rem; margin:auto">
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                                    return '<p style="text-align:center; height:10px"><a href="#" onclick="showEdit(' + data.id + ')"><i class="fa-solid fa-pen-to-square"></i></a></p>';
                        }
                    },
                ]
            });
